...
import { LayoutDashboard, CalendarDays, CalendarX2, ClipboardList, Users, QrCode, Clock3, User, Menu, X, Moon, Sun, LogOut, Stethoscope, ChevronLeft, ChevronRight, HeartPulse } from 'lucide-react';
           ...
           {links.map((item) => {
            ...
            return (
              <NavLink 
                ...
                {!collapsed || open ? <span className="truncate">{item.label}</span> : null}
              </NavLink>
            );
          })}
        </nav>
